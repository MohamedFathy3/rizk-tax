...
export function WhyUs() {
  return <section className="reference-photo-about"><div className="container photo-about-grid"><div className="photo-about-copy"><span className="eyebrow">نبذة عن رزق تاكس</span>
  <h2>مكتب رزق  للمحاسبة والاستشارات المحاسبية والضريبية</h2><p>نقدم حلولًا دقيقة وموثوقة تخدم الأفراد ورواد الأعمال والشركات، من خلال فهم عملي للأنظمة المحاسبية والضريبية واحتياجات كل نشاط.</p><p>نلتزم بالوضوح والاحترافية والاهتمام بالتفاصيل، لمساعدتك على إدارة أعمالك واتخاذ قرارات أفضل.</p><h3>الرؤية:</h3><p className="accent-copy">أن نكون شريكًا موثوقًا يساعد عملاءه على النمو والالتزام.</p><h3>الرسالة:</h3><p className="accent-copy">تقديم خدمات محاسبية وضريبية تعتمد على المعرفة والنزاهة والاحترافية.</p><Link className="reference-outline-button" href="/about">اعرف المزيد <ArrowLeft size={14} /></Link></div><div className="photo-about-badge"><img src="/logo.png" alt="شعار رزق تاكس" /></div></div></section>;
}
